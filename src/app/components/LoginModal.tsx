...
export default function LoginModal({ type = "signup", onClose, onToggleType }: LoginModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (activeTab === "login") {
        ...
        // We can access the user from auth context
        
        // Post additional user info to our backend
        try {
        ...
        if (referralCode && auth.user) {
          await processSignupReferral(referralCode, auth.user);
        }
